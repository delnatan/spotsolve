"""How far is `gsolve` from the CRLB, and how much of the gap is unavoidable?
...
def collect(size, densities, seeds, radius, bg):
    recs = []
    for dens in densities:
        for seed in range(seeds):
            ...
            p, a, se = gsolve.refine(d_e, truth.copy(), amps.copy(), SIGMA,
                                     sim.background)
            ...
            r = gsolve.detect(raw, sigma=SIGMA, offset=OFFSET, gain=GAIN,
                              verbose=0)
